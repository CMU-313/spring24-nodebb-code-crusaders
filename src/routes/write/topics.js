...
module.exports = function () {
    ...
    setupApiRoute(
        ...
        'put',
        '/:tid/tags',
        [...middlewares, middleware.checkRequired.bind(null, ['tags']), middleware.assert.topic],
    ...
    setupApiRoute(
        ...
        'post',
        '/:tid/thumbs',
        [multipartMiddleware, middleware.validateFiles, middleware.uploads.ratelimit, ...middlewares],
