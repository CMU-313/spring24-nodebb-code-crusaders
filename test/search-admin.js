...
describe('admin search', () => {
    describe('filterDirectories', () => {
        it('should resolve all paths to relative paths', (done) => {
            assert.deepEqual(search.filterDirectories(['hfjksfd/fdsgagag/admin/gdhgfsdg/sggag.tpl']), [
        ...
        it('should exclude files in the admin directory', (done) => {
            assert.deepEqual(
                search.filterDirectories(['hfjksfd/fdsgagag/admin/gdhgfsdg/sggag.tpl', 'dfdasg/admin/hjkdfsk.tpl']),
                ['admin/gdhgfsdg/sggag']
            );
            done();
        });
    ...
    describe('sanitize', () => {
        it('should strip out scripts', (done) => {
            assert.equal(
                search.sanitize('Pellentesque tristique senectus' + '<script>alert("nope");</script> habitant morbi'),
    ...
    describe('simplify', () => {
        it('should remove all mustaches', (done) => {
            assert.equal(
                ...
                'Pellentesque tristique habitant morbi' + 'liquam tincidunt risus'
            );
            done();
        });
