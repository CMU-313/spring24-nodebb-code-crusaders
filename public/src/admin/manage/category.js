...
define('admin/manage/category', [
    ...
    Category.init = function () {
        ...
        $('#category-settings input, #category-settings select, #category-settings textarea').on(
            'change',
            function (ev) {
                modified(ev.target);
            }
        ...
        $('#save').on('click', function () {
            ...
            api.put('/categories/' + cid, updateHash)
                .then((res) => {
                    ...
                    buttons: {
                        save: {
                            ...
                            callback: function () {
                                ...
                                api.del('/categories/' + ajaxify.data.category.cid)
                                    .then(() => {
                                        if (intervalId) {
        ...
        $('button[data-action="setParent"], button[data-action="changeParent"]').on(
            'click',
            Category.launchParentSelector
        );
