 ...
 *  An extension for Bootstrap's fixed navbar which hides the navbar while the
 *  page is scrolling downwards and shows it the other way. The plugin is able
 *  to show/hide the navbar programmatically as well.
...
(function ($, window, document) {
    ...
    var _throttleDelay = 70;
    var _lastScrollHandlerRun = 0;
